...
class Settings(BaseSettings):
    ...
    scan_option_pcr_enabled: bool = True  # Enrich US scan rows with Schwab 14-28 DTE volume PCR when credentials exist
    scan_option_pcr_min_dte: int = 14
    scan_option_pcr_max_dte: int = 28
